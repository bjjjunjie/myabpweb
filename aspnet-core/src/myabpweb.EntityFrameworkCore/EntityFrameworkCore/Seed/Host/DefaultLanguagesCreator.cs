...
namespace myabpweb.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly myabpwebDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = myabpwebConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(myabpwebDbContext context)
        {
            _context = context;
        }
