...
{
    public abstract class myabpwebWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static myabpwebWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(myabpwebWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<myabpwebDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<myabpwebDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<myabpwebDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<myabpwebDbContext, Task<T>> func)
        {
            T result;
